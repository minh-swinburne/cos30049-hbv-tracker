---
title: "Age-specific vaccination coverage line plot"
...
province_coverage_plot_line <- function(data_temp) {
...
region_coverage_plot_line <- function(data_temp) {
...
interactive_plot <- region_coverage_plot_line(data_temp)
interactive_plot
```
...
data_temp <- data_wide %>% filter(HBVnewborn_delay == 0 )
interactive_plot <- province_coverage_plot_line(data_temp)
interactive_plot
```
### b. HBVnewborn possible coverage
